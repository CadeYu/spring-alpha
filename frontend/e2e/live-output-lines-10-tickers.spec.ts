...
const TASK_CASES: TaskCase[] = [
  ...
  },
  {
    ...
    reportHeading: /Market Narrative & Sentiment/i,
    requiredComponents: [
      /Market Narrative & Sentiment/i,
      /Market Narrative/i,
      /Narrative Snapshot/i,
      /Bull Case/i,
      /Bear Case/i,
      /Balanced Read/i,
      /Source Divergence/i,
    ...
    qualitySignals: [
      /\bbullish\b|\bbearish\b|\bmixed\b|\bneutral\b/i,
      /\bnews\b|\bStockTwits\b|\bReddit\b|\bsocial\b|\bnarrative\b/i,
      /\bsentiment\b|\bbull\b|\bbear\b|\bsource divergence\b|\bmarket narrative\b/i,
    ],
  },
  {
    ...
    requiredComponents: [
      ...
      /Cash Quality/i,
      /Cash Flow Bridge/i,
      /Capex and Reinvestment/i,
      /Balance Sheet Resilience and Debt/i,
      /Risk Signals and Watch Next/i,
      /Key Cash Metrics Table/i,
      /Final Analyst Outlook/i,
    ],
    qualitySignals: [
      ...
      /\ballocation\b|\bdiscipline\b|\brisk signals\b|\bwatch next\b|\bquality\b/i,
    ],
  },
];
