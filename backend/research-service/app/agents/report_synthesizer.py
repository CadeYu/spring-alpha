...
def _ascii_term_pattern(term: str) -> re.Pattern[str]:
    ...
    return re.compile(rf"(?<![A-Za-z]){escaped}(?![A-Za-z])", flags=re.I)
...
_ZH_VISIBLE_TECH_TERM_REPLACEMENTS = (
    ...
    (_ascii_term_pattern("Caution"), "谨慎"),
    (_ascii_term_pattern("Negative"), "偏承压"),
    (_ascii_term_pattern("Positive"), "偏积极"),
    (_ascii_term_pattern("Neutral"), "中性"),
    ...
    (_ascii_term_pattern("Digital Media"), "数字媒体"),
    (_ascii_term_pattern("Creative Cloud"), "创意云"),
    (_ascii_term_pattern("Document Cloud"), "文档云"),
    (_ascii_term_pattern("Microsoft Designer"), "微软 Designer"),
    (re.compile(r"\bCanva\b", flags=re.I), "Canva"),
    (re.compile(r"\bFirefly\b", flags=re.I), "Firefly"),
    (_ascii_term_pattern("Medicare Advantage"), "联邦医保优势计划"),
    (_ascii_term_pattern("UnitedHealthcare"), "联合健康保险"),
    (_ascii_term_pattern("Optum Health"), "Optum 健康"),
    (_ascii_term_pattern("Optum Health/Insight/Rx"), "Optum 健康/数据分析/药房福利"),
    (_ascii_term_pattern("Optum Insight"), "Optum 数据分析"),
    (_ascii_term_pattern("Optum Rx"), "Optum 药房福利"),
    (_ascii_term_pattern("Insight/Rx"), "数据分析/药房福利"),
    ...
    (re.compile(r"\bthe\s+每股收益\b", flags=re.I), "每股收益"),
    (re.compile(r"\bthe\s+long-term\s+case\b", flags=re.I), "长期逻辑"),
    (re.compile(r"\bevidence\b", flags=re.I), "证据"),
    (re.compile(r"\bintact\b", flags=re.I), "仍然成立"),
    (re.compile(r"\bis\s+仍然成立\b", flags=re.I), "仍然成立"),
    (re.compile(r"\bremains\s+仍然成立\b", flags=re.I), "仍然成立"),
    (re.compile(r"\bfor\s+企业端\s+客户\b", flags=re.I), "面向企业端客户"),
    ...
    (re.compile(r"\bcan\s+重置\b", flags=re.I), "可能重置"),
    ...
    (re.compile(r"\band\b", flags=re.I), "和"),
    (re.compile(r"\badoption\b", flags=re.I), "采用率"),
    (re.compile(r"\badopts?\b", flags=re.I), "采用"),
    (re.compile(r"\bcreators?\b", flags=re.I), "创作者"),
    (re.compile(r"\bsoftware\b", flags=re.I), "软件"),
    (re.compile(r"\bgrowth\b", flags=re.I), "增长"),
    (re.compile(r"\bdepends on\b", flags=re.I), "取决于"),
    (re.compile(r"\blifted\b", flags=re.I), "提升"),
    (re.compile(r"\blift\b", flags=re.I), "提升"),
    (re.compile(r"\bimproved\b", flags=re.I), "改善"),
